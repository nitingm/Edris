...
public interface IPhotoView {
     ...
     * @param listener - Listener to be registered.
     */
    void setOnMatrixChangeListener(com.example.ecom.photoview.view.PhotoViewAttacher.OnMatrixChangedListener listener);
     ...
     * @param listener - Listener to be registered.
     */
    void setOnPhotoTapListener(com.example.ecom.photoview.view.PhotoViewAttacher.OnPhotoTapListener listener);
     ...
     */
    com.example.ecom.photoview.view.PhotoViewAttacher.OnPhotoTapListener getOnPhotoTapListener();
     ...
     * @param listener - Listener to be registered.
     */
    void setOnViewTapListener(com.example.ecom.photoview.view.PhotoViewAttacher.OnViewTapListener listener);
     ...
     */
    com.example.ecom.photoview.view.PhotoViewAttacher.OnViewTapListener getOnViewTapListener();
     ...
     */
    void setOnScaleChangeListener(com.example.ecom.photoview.view.PhotoViewAttacher.OnScaleChangeListener onScaleChangeListener);
}
