...
public class ImageUrlUtils {
    ...
    static ArrayList<String> compareListImageUri = new ArrayList<>();
    ...
    public static String[] getElectronicsUrls() {
        String[] urls = new String[]{
                "https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQLEEveHak7ZlBytszZDNSjK3RqZ2KYCGVMB8RnNOnBgmlpJahX&usqp=CAU",
                "https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcTew8sG-D-Is6ZoK4JuZ_zmUY4AxSqtwkzGmHkLfglVHQTM7tER&usqp=CAU",
    ...
    public void addCompareListImageUri(String compareListImageUri) {
        this.compareListImageUri.add(0,compareListImageUri);
    }

    public void removeCompareListImageUri(int position) {
        this.compareListImageUri.remove(position);
    }

    public ArrayList<String> getCompareListImageUri(){ return this.compareListImageUri; }

    public int getCompareListSize() { return this.compareListImageUri.size();}
}
